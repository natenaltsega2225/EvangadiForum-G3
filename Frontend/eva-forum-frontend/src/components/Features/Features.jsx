  ...
  return (
    <div className={styles.featuresContainer}>
      ...
      <ol className={styles.stepList}>
        ...
        <li className={styles.stepItem}>
          Navigate to the "Ask a Question" page to submit your queries.
        </li>
        <li className={styles.stepItem}>
          Browse existing questions and provide answers if you can.
        </li>
        <li className={styles.stepItem}>
          Engage with the community and provide feedback on answers.
        </li>
        <li className={styles.stepItem}>
